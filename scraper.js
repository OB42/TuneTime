...
function getValuesAsProperties(propertyRules, elements){
    ...
    if(sameLength){
        ...
        /*If the css selectors don't match the same number of elements,
        ...
        /*We're trying to find an element that contain exactly 1 child matching each css selectors,
        to determine in which order we need to extract the data*/
